...
import 'package:safe_space_01/core/core.dart';
import 'package:safe_space_01/core/providers.dart';
...
class TweetAPI implements ITweetAPI {
  ...
  FutureEither<Document> shareTweet(Tweet tweet) async {
    ...
    try {
      ...
      return left(
        Failure(e.message ?? 'error in shareTweet', st),
      );
    } catch (e, st) {
  ...
  FutureEither<Document> likeTweet(Tweet tweet) async {
    try {
      ...
      return left(
        Failure(e.message ?? 'error in likeTweet', st),
      );
    } catch (e, st) {
      return left(Failure(e.toString(), st));
    }
